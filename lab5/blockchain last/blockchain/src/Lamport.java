...
public static String getMerkleRoot(ArrayList<Transaction> transactions) throws NoSuchAlgorithmException {
	...
	return merkleRoot;
	 ...
	 public static void main(String[] args) throws Exception {
		...
		ArrayList<BigInteger> bloc1 = Lamport.generBit(256) ;
		ArrayList<BigInteger> bloc2 = Lamport.generBit(256) ;
		//ArrayList<ArrayList<BigInteger>> arr=Lamport.privateKeys(bloc1, bloc2);

		//Private key bloc generation
		ArrayList<String> bloc_hash1 = Lamport.publicKey(bloc1);
		ArrayList<String> bloc_hash2 = Lamport.publicKey(bloc2);
		ArrayList<ArrayList<String>> arrpub=Lamport.publicKeys(bloc_hash1,bloc_hash2);
		...
		String messagehash=Lamport.hash(message);

		//generate signature
		ArrayList<BigInteger> signatures = Lamport.privateSignature(messagehash, bloc1, bloc2);

		// Signature verification using the message hash
		//ArrayList<String> Psignatures = Lamport.publicSignature(messagehash, bloc_hash1, bloc_hash2);
			// Hashage of the signature
		//ArrayList<String> hashsignature = Lamport.publicKey(signatures);
		

		System.out.println(Lamport.privateKeys(bloc1, bloc2));
		System.out.println(Lamport.publicKeys(bloc_hash1, bloc_hash2));
		System.out.println(Lamport.verifySignature(message, signatures, arrpub));
