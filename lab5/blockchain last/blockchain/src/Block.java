...
public class Block {
	...
	public String calculateHash() throws NoSuchAlgorithmException {
		String calculatedhash = Lamport.hashex( 
				previousHash +
	...
	public void mineBlock(int difficulty) throws NoSuchAlgorithmException {
		merkleRoot = Lamport.getMerkleRoot(transactions);
		String target = Lamport.getDificultyString(difficulty); //Create a string with difficulty * "0" 
